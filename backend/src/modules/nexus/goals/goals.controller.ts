...
export async function getGoals(c: Context): Promise<Response> {
  return handleApi(c, async () => ({ goals: await listGoals() }), 'Fetch failed');
}

export async function getDashboard(c: Context): Promise<Response> {
  return handleApi(c, () => getGoalsDashboard(), 'Fetch failed');
}

export async function getProfileHandler(c: Context): Promise<Response> {
  return handleApi(c, async () => ({ profile: await getProfile() }), 'Fetch failed');
}

export async function getWeights(c: Context): Promise<Response> {
  return handleApi(c, async () => ({ entries: await listWeights(365) }), 'Fetch failed');
}
...
export async function postSubGoal(c: Context): Promise<Response> {
  try {
    ...
    Logger.error('Create sub-goal error:', error);
    return c.json(
      {
        success: false,
        error: 'Create failed',
...
export async function putSubGoal(c: Context): Promise<Response> {
  try {
    ...
    Logger.error('Update sub-goal error:', error);
    return c.json(
      {
        success: false,
        error: 'Update failed',
...
export async function removeSubGoal(c: Context): Promise<Response> {
  try {
    ...
    Logger.error('Delete sub-goal error:', error);
    return c.json(
      {
        success: false,
        error: 'Delete failed',
...
export async function postWeight(c: Context): Promise<Response> {
  try {
    ...
    Logger.error('Create weight error:', error);
    return c.json(
      {
        success: false,
        error: 'Create failed',
...
export async function removeWeight(c: Context): Promise<Response> {
  try {
    ...
    Logger.error('Delete weight error:', error);
    return c.json(
      {
        success: false,
        error: 'Delete failed',
